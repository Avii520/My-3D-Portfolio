        ...
        <div className="showcaselayout">
          ...
          <div className="project-list-wrapper overflow-hidden">
            <div className="project" ref={libraryRef}>
              ...
              <h2>Interactive Cocktail Landing Page</h2>
              <p className="text-white-50 md:text-xl mt-1">
                A modern cocktail landing page built with React, Tailwind CSS,
                and GSAP, featuring smooth animations and a responsive,
                immersive design.
              </p>
            </div>
